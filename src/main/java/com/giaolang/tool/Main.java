...
import com.giaolang.tool.mathutil.core.MathUtility;
...
public class Main {
    ...
    public static void testFactorialGivenRightArgument1RunsWell() {
        int n = 1;
        long expected = 1;
        long actual = MathUtility.getFactorial(n); //thực tế là mấy đoánn xem
...
//TEST CASE DÙNG ĐỂ TEST HÀM (KO NHẦM VỚI TEST APP - TEST MÀN HÌNH UI VÀ NHẬP LIỆU...), CHỈ DÀNH CHO CHÍNH DÂN DEV (DÂN QA/QC KO DÍNH VÀO CODE CỦA PROJECT)

//NHỜ TDD, TDD ĐÓNG GÓP 1 PHẦN GIÚP TA TỰ ĐỘNG HOÁ QUÁ TRÌNH BUILD, CHECK BUG, ĐÓNG GÓI NẾU CODE ỔN, DEPLOY LÊN STAGING SERVER (SERVER ĐỂ TEST APP)
